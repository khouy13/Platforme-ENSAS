...
namespace Projet.Migrations
{
    ...
    [Migration("20240310101736_MatiereCommunAdded")]
    partial class MatiereCommunAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Projet.Areas.Coordonnateur.Models.EmploiExam", b =>
                {
                    ...
                    b.Property<DateTime?>("DateEmploiExam")
            ...
            modelBuilder.Entity("Projet.Areas.Coordonnateur.Models.TypeLocal", b =>
                {
                    b.Property<int>("IdTypeLocal")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdTypeLocal"));

                    b.Property<string>("Nom")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("IdTypeLocal");

                    b.ToTable("TypeLocals");
                });
            ...
            modelBuilder.Entity("Projet.Areas.Responsable.Models.Grade", b =>
                {
                    b.Property<int>("GradeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("GradeNomComplet")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Projet.Areas.Responsable.Models.MatiereCommun", b =>
                {
                    ...
                    b.Property<int>("MainMatiereIdMatiere")
                        .HasColumnType("int");

                    b.Property<int>("RelatedMatiereIdMatiere")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("MainMatiereIdMatiere");

                    b.HasIndex("RelatedMatiereIdMatiere");
            ...
            modelBuilder.Entity("Projet.Areas.Admin.Models.Enseignant", b =>
                {
                    b.HasOne("Projet.Areas.Responsable.Models.Grade", "gradeEnseigant")
            ...
            modelBuilder.Entity("Projet.Areas.Coordonnateur.Models.Local", b =>
                {
                    b.HasOne("Projet.Areas.Coordonnateur.Models.TypeLocal", "TypeLocal")
                        .WithMany("Locals")
                        .HasForeignKey("IdTypeLocal");

                    b.Navigation("TypeLocal");
                });
            ...
            modelBuilder.Entity("Projet.Areas.Responsable.Models.Matiere", b =>
                {
                    b.HasOne("Projet.Areas.Admin.Models.Enseignant", "Enseignant")
                        .WithMany("EnseignatMatiere")
                        .HasForeignKey("IdEnseignant");

                    b.HasOne("Projet.Areas.Responsable.Models.Vacataire", "Vacataire")
                        .WithMany("MatiereVacataire")
                        .HasForeignKey("IdVacataire");
            ...
            modelBuilder.Entity("Projet.Areas.Responsable.Models.MatiereCommun", b =>
                {
                    b.HasOne("Projet.Areas.Responsable.Models.Matiere", "MainMatiere")
                        ...
                        .HasForeignKey("MainMatiereIdMatiere")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Projet.Areas.Responsable.Models.Matiere", "RelatedMatiere")
                        .WithMany()
                        .HasForeignKey("RelatedMatiereIdMatiere")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Projet.Areas.Responsable.Models.MatiereNiveau", b =>
                {
                    b.HasOne("Projet.Areas.Responsable.Models.Matiere", "Matiere")
                        .WithMany("MatiereNiveaus")
                        .HasForeignKey("IdMatiere");

                    b.HasOne("Projet.Areas.Responsable.Models.Niveau", "Niveau")
                        .WithMany("NiveauMatieres")
                        .HasForeignKey("IdNiveau");
            ...
            modelBuilder.Entity("Projet.Areas.Responsable.Models.Vacataire", b =>
                {
                    ...
                    b.Navigation("MatiereVacataire");
                });

            modelBuilder.Entity("Projet.Data.ApplicationUser", b =>
                {
                    b.Navigation("Departemets");
