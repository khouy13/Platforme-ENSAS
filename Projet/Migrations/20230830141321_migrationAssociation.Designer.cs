...
namespace Projet.Migrations
{
    ...
    [Migration("20230830141321_migrationAssociation")]
    partial class migrationAssociation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Projet.Areas.Admin.Models.Enseignant", b =>
                {
                    ...
                    b.Property<int?>("emploiExamIdEmploiExam")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("emploiExamIdEmploiExam");
            ...
            modelBuilder.Entity("Projet.Areas.Admin.Models.Enseignant", b =>
                {
                    ...
                    b.HasOne("Projet.Areas.Coordonnateur.Models.EmploiExam", "emploiExam")
                        .WithMany()
                        .HasForeignKey("emploiExamIdEmploiExam");
